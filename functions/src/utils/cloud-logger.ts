 ...
 * All logs conform to the StructuredLogEntry schema from @jsdubzw/job-finder-shared-types.
 *
 * Usage:
 * ```typescript
...
import type { StructuredLogEntry, CloudLoggingLabels, LogLevel } from '@jsdubzw/job-finder-shared-types'
